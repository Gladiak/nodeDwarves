...
- candidate report: `/Users/gladiak/ProgettiLavoro/nodeDwarves/debug/candidate_reports_3000/c_low_issuance.json`
- baseline variant: `baseline`
- candidate variant: `c_low_issuance`
...
| metric | abs | rel |
| --- | ---: | ---: |
| population | +18.8 | +7.43% |
| morale | +0.0044 | +0.50% |
| beerBoost | +0.0021 | +12.20% |
| hunger | -0.0033 | -2.08% |
| thirst | -0.0022 | -1.94% |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| deep_claims | 0 | 0.00% | +0.71pp | 0 | 0.00% | +0.71pp |
| forge_quota | 0 | 0.00% | +0.71pp | 0 | 0.00% | +0.71pp |
| frontier_levy | 0 | 0.00% | +0.95pp | 0 | 0.00% | +0.95pp |
| granary_compact | -1 | -12.50% | -3.10pp | -200 | -12.50% | -3.10pp |
