...
- candidate report: `/Users/gladiak/ProgettiLavoro/nodeDwarves/debug/candidate_reports_3000/c_granary_hearth.json`
- baseline variant: `baseline`
- candidate variant: `c_granary_hearth`
...
| food | 0.0 | 0.00% |
| water | 0.0 | 0.00% |
| resource_avg_rel | n/a | 0.00% |

## Schism Decree Deltas

| metric | abs | rel |
| --- | ---: | ---: |
| decrees_issued_total | 0 | 0.00% |
| decrees_active_ticks_total | 0 | 0.00% |

| decree | issued abs | issued rel | issued share delta | active ticks abs | active ticks rel | active share delta |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| deep_claims | 0 | 0.00% | 0.00pp | 0 | 0.00% | 0.00pp |
| forge_quota | 0 | 0.00% | 0.00pp | 0 | 0.00% | 0.00pp |
| frontier_levy | 0 | 0.00% | 0.00pp | 0 | 0.00% | 0.00pp |
| granary_compact | 0 | 0.00% | 0.00pp | 0 | 0.00% | 0.00pp |
| hearth_festivity | 0 | 0.00% | 0.00pp | 0 | 0.00% | 0.00pp |
...
| 202 | population | 0.0 | 0.00% |
| 202 | morale | 0.0000 | 0.00% |
| 202 | beerBoost | 0.0000 | 0.00% |
| 202 | hunger | 0.0000 | 0.00% |
| 202 | thirst | 0.0000 | 0.00% |
