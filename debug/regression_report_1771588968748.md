...
Generated: 2026-02-20T12:02:48.754Z
...
| Metric | Current | Baseline | Delta | Delta% | Threshold | Status |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| avg_reward | 9359.103 | 9255.690 | 103.413 | 1.1% | 8792.906 | OK |
| avg_steps | 1200.000 | 1200.000 | 0.000 | 0.0% | n/a | N/A |
| avg_births | 48.825 | 52.075 | -3.250 | -6.2% | n/a | N/A |
| avg_deaths | 2.500 | 1.875 | 0.625 | 33.3% | 2.156 | REGRESS |
| score | 3.900 | 3.857 | 0.043 | 1.1% | 3.664 | OK |
...
| Seed | avg_reward | avg_steps | avg_births | avg_deaths | score |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 12345 | 9368.957 | 1200.000 | 48.050 | 2.750 | 3.904 |
| 22222 | 9349.249 | 1200.000 | 49.600 | 2.250 | 3.896 |
...
| Metric | Current | Baseline | Delta | Delta% | Threshold | Status |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| avg_reward | 9338.205 | 9338.205 | 0.000 | 0.0% | 8871.295 | OK |
| avg_steps | 1200.000 | 1200.000 | 0.000 | 0.0% | n/a | N/A |
| avg_births | 48.825 | 48.825 | 0.000 | 0.0% | n/a | N/A |
| avg_deaths | 2.225 | 2.225 | 0.000 | 0.0% | 2.559 | OK |
| score | 3.891 | 3.891 | 0.000 | 0.0% | 3.696 | OK |

### Randomized diff

| Metric | Current | Baseline | Delta | Delta% | Threshold | Status |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| avg_reward | 3970.350 | 3970.350 | 0.000 | 0.0% | 3652.722 | OK |
| avg_steps | 520.000 | 520.000 | 0.000 | 0.0% | n/a | N/A |
| avg_births | 13.660 | 13.660 | 0.000 | 0.0% | n/a | N/A |
...
| raid_count | 0.350 | 0.350 | 0.000 | 0.0% | n/a | N/A |
| raid_deaths | 0.425 | 0.425 | 0.000 | 0.0% | n/a | N/A |
| raid_exposed | 0.835 | 0.835 | 0.000 | 0.0% | n/a | N/A |
| raid_defense | 0.600 | 0.600 | 0.000 | 0.0% | n/a | N/A |
| under_depthProgress | 0.000 | 0.000 | 0.000 | n/a | n/a | N/A |
| under_championProgress | 0.000 | 0.000 | 0.000 | n/a | n/a | N/A |
| under_frontierContested | 0.000 | 0.000 | 0.000 | n/a | n/a | N/A |
| under_championCooldown | 0.000 | 0.000 | 0.000 | n/a | n/a | N/A |
| under_readinessScore | 0.610 | 0.610 | 0.000 | 0.0% | n/a | N/A |
| under_readinessGap | 0.390 | 0.390 | 0.000 | 0.0% | n/a | N/A |
| under_readinessBlocked | 0.525 | 0.525 | 0.000 | 0.0% | n/a | N/A |
| under_readinessWarning | 0.475 | 0.475 | 0.000 | 0.0% | n/a | N/A |
| under_combatPressure | 0.235 | 0.235 | 0.000 | 0.0% | n/a | N/A |
| node_food | 0.160 | 0.160 | 0.000 | 0.0% | n/a | N/A |
| node_water | 0.060 | 0.060 | 0.000 | 0.0% | n/a | N/A |
| node_wood | 0.165 | 0.165 | 0.000 | 0.0% | n/a | N/A |
| node_stone | 0.075 | 0.075 | 0.000 | 0.0% | n/a | N/A |
| short_food | 0.040 | 0.040 | 0.000 | 0.0% | n/a | N/A |
...
| Seed | avg_reward | avg_steps | avg_births | avg_deaths | score |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 12345 | 9358.139 | 1200.000 | 49.050 | 2.300 | 3.899 |
| 22222 | 9318.271 | 1200.000 | 48.600 | 2.150 | 3.883 |
